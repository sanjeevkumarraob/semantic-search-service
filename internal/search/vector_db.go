...
// VectorSearchParams contains parameters for search operations
...
func (s *QdrantStore) Search(ctx context.Context, params *VectorSearchParams) ([]*VectorSearchResult, error) {
	s.lock.RLock()
	defer s.lock.RUnlock()
